...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Player.result'
        db.alter_column(u'player_player', 'result', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Player.result'
        db.alter_column(u'player_player', 'result', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'player.player': {
            ...
            'result': ('django.db.models.fields.FloatField', [], {'default': '0.0', 'blank': 'True'}),
