...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Round.total'
        db.add_column(u'game_round', 'total',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['game.Total']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Round.total'
        db.delete_column(u'game_round', 'total_id')
