...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'game_game', 'start',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2013, 8, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Round.start'
        db.add_column(u'game_round', 'start',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 8, 13, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.start'
        db.delete_column(u'game_game', 'start')

        # Deleting field 'Round.start'
        db.delete_column(u'game_round', 'start')
    ...
    models = {
        u'game.game': {
            ...
            'btime_limit': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 8, 13, 0, 0)', 'blank': 'True'}),
            ...
            'wtime_limit': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 8, 13, 0, 0)', 'blank': 'True'})
        },
        u'game.round': {
